...
public interface Converter {
    ...
    @RequestWrapper(localName = "execute", targetNamespace = "http://schema.webpdf.de/1.0/soap/converter", className = "de.webpdf.sample.stubs.converter.Execute")
    @ResponseWrapper(localName = "executeResponse", targetNamespace = "http://schema.webpdf.de/1.0/soap/converter", className = "de.webpdf.sample.stubs.converter.ExecuteResponse")
