 ...
 * 
 */
@WebServiceClient(name = "SignatureService", targetNamespace = "http://schema.webpdf.de/1.0/soap/signature", wsdlLocation = "http://localhost:8080/webPDF/soap/signature?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SIGNATURESERVICE_QNAME = new QName("http://schema.webpdf.de/1.0/soap/signature", "SignatureService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webPDF/soap/signature?wsdl");
     ...
     *     returns Signature
     */
    @WebEndpoint(name = "SignaturePort")
    public Signature getSignaturePort() {
        return super.getPort(new QName("http://schema.webpdf.de/1.0/soap/signature", "SignaturePort"), Signature.class);
    }
     ...
     */
    @WebEndpoint(name = "SignaturePort")
    public Signature getSignaturePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://schema.webpdf.de/1.0/soap/signature", "SignaturePort"), Signature.class, features);
    }
