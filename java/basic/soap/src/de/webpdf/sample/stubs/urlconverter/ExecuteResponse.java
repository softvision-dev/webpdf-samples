...
@XmlType(name = "executeResponse", namespace = "http://schema.webpdf.de/1.0/soap/urlconverter", propOrder = {
    "_return"
})
public class ExecuteResponse {

    @XmlElementRef(name = "return", type = JAXBElement.class, required = false)
    protected JAXBElement<DataHandler> _return;
     ...
     *     
     */
    public JAXBElement<DataHandler> getReturn() {
        return _return;
    }
     ...
     *     
     */
    public void setReturn(JAXBElement<DataHandler> value) {
        this._return = value;
    }
