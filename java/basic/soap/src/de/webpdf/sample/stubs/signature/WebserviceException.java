 ...
 * 
 */
@WebFault(name = "WebserviceException", targetNamespace = "http://schema.webpdf.de/1.0/soap/signature")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: de.webpdf.sample.stubs.signature.FaultInfo
     */
