 ...
 * generated in the de.webpdf.sample.stubs.urlconverter package. 
...
public class ObjectFactory {
    ...
    private final static QName _Execute_QNAME = new QName("http://schema.webpdf.de/1.0/soap/urlconverter", "execute");
    private final static QName _WebserviceException_QNAME = new QName("http://schema.webpdf.de/1.0/soap/urlconverter", "WebserviceException");
    private final static QName _ExecuteResponse_QNAME = new QName("http://schema.webpdf.de/1.0/soap/urlconverter", "executeResponse");
    private final static QName _ExecuteResponseReturn_QNAME = new QName("", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.webpdf.sample.stubs.urlconverter
     * 
     */
    ...
    /**
     * Create an instance of {@link UrlConverterType }
     * 
     */
    ...
    /**
     * Create an instance of {@link HttpBasicAuthType }
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/urlconverter", name = "execute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/urlconverter", name = "WebserviceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/urlconverter", name = "executeResponse")
