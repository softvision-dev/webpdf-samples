...
public interface Barcode {
    ...
    @RequestWrapper(localName = "execute", targetNamespace = "http://schema.webpdf.de/1.0/soap/barcode", className = "de.webpdf.sample.stubs.barcode.Execute")
    @ResponseWrapper(localName = "executeResponse", targetNamespace = "http://schema.webpdf.de/1.0/soap/barcode", className = "de.webpdf.sample.stubs.barcode.ExecuteResponse")
