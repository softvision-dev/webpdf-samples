 ...
 * generated in the de.webpdf.sample.stubs.pdfa package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExecuteResponse_QNAME = new QName("http://schema.webpdf.de/1.0/soap/pdfa", "executeResponse");
    private final static QName _Execute_QNAME = new QName("http://schema.webpdf.de/1.0/soap/pdfa", "execute");
    private final static QName _WebserviceException_QNAME = new QName("http://schema.webpdf.de/1.0/soap/pdfa", "WebserviceException");
    private final static QName _ExecuteResponseReturn_QNAME = new QName("", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.webpdf.sample.stubs.pdfa
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/pdfa", name = "executeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/pdfa", name = "execute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schema.webpdf.de/1.0/soap/pdfa", name = "WebserviceException")
