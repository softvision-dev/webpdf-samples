...
public interface OCR {
    ...
    @RequestWrapper(localName = "execute", targetNamespace = "http://schema.webpdf.de/1.0/soap/ocr", className = "de.webpdf.sample.stubs.ocr.Execute")
    @ResponseWrapper(localName = "executeResponse", targetNamespace = "http://schema.webpdf.de/1.0/soap/ocr", className = "de.webpdf.sample.stubs.ocr.ExecuteResponse")
