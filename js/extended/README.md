# webPDF Extended Sample for JavaScript

This sample shows the use of the REST web service from JavaScript via Ajax. 

The samples shown contain the following functions:
...
## Instructions
- Open the project file **'extended.iml'** in the [IntelliJ IDEA](https://www.jetbrains.com/idea) 
